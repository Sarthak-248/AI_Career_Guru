...
type SentAlertPayload = {
  id: string;
  createdAt: string;
  delivered: boolean;
  jobListing: JobListingPayload | null;
};
...
export function AlertsClient({ initialSubscriptions }: Props) {
  const [subscriptions, setSubscriptions] =
    useState<SubscriptionPayload[]>(initialSubscriptions);
